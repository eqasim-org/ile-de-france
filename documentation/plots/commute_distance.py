...
def execute(context):
    ...
    for part in parts:
        ...
        plt.plot(hts_data[slot]["euclidean_distance"] * 1e-3, hts_data[slot]["cdf"], color = plotting.COLORS["egt"], linestyle = part["linestyle"], linewidth = 1.0)
    ...
    plt.plot([np.nan], color = plotting.COLORS["egt"], linewidth = 1.0, label = "EGT")
