...
def execute(context):
    ...
    df_vehicle_types = pd.DataFrame.from_records([{
        "type_id": "default_motorbike", "nb_seats": 4, "length": 5.0, "width": 1.0, "pce": 1.0, "mode": "motorbike",
    ...
    df_vehicles["mode"] = "motorbike"

    df_vehicles["vehicle_id"] = df_vehicles["owner_id"].astype(str) + ":motorbike"
    df_vehicles["type_id"] = "default_motorbike"
