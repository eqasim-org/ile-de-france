...
def execute(context):
    ...
    # Clean departement
    df_persons["departement_id"] = df_persons["RESDEP"].astype("category")
    df_households["departement_id"] = df_households["RESDEP"].astype("category")
    df_trips["origin_departement_id"] = df_trips["ORDEP"].astype("category")
    df_trips["destination_departement_id"] = df_trips["DESTDEP"].astype("category")
